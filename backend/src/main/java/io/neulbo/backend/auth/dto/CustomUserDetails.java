...
public class CustomUserDetails implements UserDetails {
    ...
    public CustomUserDetails(UUID userId, String provider) {
        this.userId = userId;
    ...
    public CustomUserDetails(UUID userId, String provider, Collection<? extends GrantedAuthority> authorities) {
        this.userId = userId;
        this.provider = provider;
